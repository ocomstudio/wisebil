...
2.  **Extract ALL Transactions:** Identify every transaction, whether it's a debit (money spent) or a credit (money received). Do not separate them into incomes and expenses yet; place all of them in a single 'transactions' array. Use a negative sign for expenses (e.g., -5000) and a positive sign for incomes (e.g., 10000).
